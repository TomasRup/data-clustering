(function () {
    ...
    GraphController.prototype = {
        ...
        initOnClickEventOnPoint: function(pointElement, labelForExplanatoryText) {
        ...
        initPointDataToPointElement: function(point, pointElement) {
            pointElement.data('name', point.name);
            pointElement.data('x', point.x);
            pointElement.data('y', point.y);
        },

        drawByUkw: function(data, set, labelForExplanatoryText) {
            // Drawing data points
            this.paper.setStart();
        ...
        drawByKMeans: function(data, set, labelForExplanatoryText) {
